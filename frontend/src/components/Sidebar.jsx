...
export default function Sidebar({
  ...
  return (
    <aside
      data-testid="sidebar"
      className={`flex-shrink-0 border-r border-[var(--n-border)] bg-[#F7F7F5] flex flex-col h-full transition-all duration-300 ${
        ...
        <div className="px-2 py-1">
                ...
                <div className="flex items-center group">
                  ...
                  >
                    ...
                    {renamingFolderId === folder.id ? (
                      ...
                      <span className="flex-1 text-sm text-[var(--n-text)] truncate">
                        {folder.name}
                      </span>
                    )}
                    <span className="text-[10px] text-[var(--n-text-secondary)]">{folderNotes.length}</span>
                  </div>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      className="w-48 bg-[var(--n-bg)] border-[var(--n-border)] rounded-lg shadow-md"
                      align="start"
                    >
                      <DropdownMenuItem
          ...
          {unorganizedNotes.length > 0 && (
            <div data-testid="unorganized-section">
              {folders.length > 0 && (
                <p className="text-[10px] font-medium text-[var(--n-text-secondary)] uppercase tracking-wider px-2 pt-3 pb-1">
                  Pages
                </p>
              )}
  ...
  return (
    ...
    >
        ...
        <div className="flex-1 min-w-0">
          ...
          {tags.length > 0 && (
            <div className="flex gap-1 mt-0.5 overflow-hidden">
              ...
              {tags.length > 2 && (
                <span className="text-[9px] text-[var(--n-text-secondary)]">+{tags.length - 2}</span>
              )}
            </div>
          )}
        </div>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent
          className="w-44 bg-[var(--n-bg)] border-[var(--n-border)] rounded-lg shadow-md"
          align="start"
        >
          <DropdownMenuItem
